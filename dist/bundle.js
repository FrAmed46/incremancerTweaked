...
(() => {
    ...
    class Xe {
        ...
        destroyItem(e) {
            this.addXp((e.l * (1 + e.l * 0.001225)) * (1.8 ** e.r) * 15 * i.persistent.xpRate);
        ...
        xpForItems() {
            ...
            return this.persistent.items.filter(e => !e.q && e.r != this.rarity.legendary).forEach((function (t) {
                e += ((t.l * (1 + t.l * 0.001225)) * (1.8 ** t.r) * 15 * i.persistent.xpRate/)
            })), e
        }
...
this.equipped = [];
                    ...
                    e.length > 0 ? helmetRow.push(e[0]) : helmetRow.push({
                        name: "Helmet Slot",
                    ...
                    b.length > 0 ? helmetRow.push(b[0]) : helmetRow.push({
                        name: "Ring Slot",
                    ...
                    p.length > 0 ? helmetRow.push(p[0]) : helmetRow.push({
                        name: "Armband Slot",
                        s: i.lootPositions.armband.id,
                        id: -9
                    });
                    
                    this.equipped.push(helmetRow);
